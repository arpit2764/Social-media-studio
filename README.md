...
AI Social Media Studio converts a simple idea into **structured, storytelling-based social media slides**.

The system takes a topic (e.g., *Why kids forget what they learn*) and generates:

* A clear problem explanation
* Scientific reasoning (e.g., forgetting curve)
...
### 🎯 1. AI-Based Slide Generation

* Converts user input into **5 structured slides**
...
* Users can regenerate **individual slides**
...
2. API processes the idea
3. Structured slides are generated dynamically
4. Slides are displayed with images and formatting
5. User can:
...
* Focused on **clarity and storytelling** over complex AI integration
* Prioritized **clean UI over editability**
* Implemented **deterministic + randomized content** for consistency
...
* Generating slides from a real problem
* Storytelling structure across slides
